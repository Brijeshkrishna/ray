...
void print_ipv6_addr(const struct sockaddr_in6 *addr) {
    char str_addr[INET6_ADDRSTRLEN];
    if (inet_ntop(AF_INET6, &addr->sin6_addr, str_addr, INET6_ADDRSTRLEN) != NULL) {
...
int main() {
    ...
    strncpy(ifr.ifr_name, "wlp3s0", IFNAMSIZ - 1); // Specify the interface name here
